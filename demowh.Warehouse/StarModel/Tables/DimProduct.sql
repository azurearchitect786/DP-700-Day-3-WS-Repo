CREATE TABLE [StarModel].[DimProduct] (
...
ALTER TABLE [StarModel].[DimProduct] ADD CONSTRAINT AK_DimProduct_ProductAlternateKey_StartDate unique NONCLUSTERED ([ProductAlternateKey], [StartDate]);
GO
ALTER TABLE [StarModel].[DimProduct] ADD CONSTRAINT PK_DimProduct_ProductKey primary key NONCLUSTERED ([ProductKey]);